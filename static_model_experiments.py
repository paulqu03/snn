...
# ------------------------------------------------------------------
base_path = Path("./experiments/decision_simulation/final_static_tests")
...
for run_idx in range(N_RUNS):
    ...
    sim_folder = base_path / "experiment_1"/ f"simulation_{run_idx+1}"
...
# ------------------------------------------------------------------
# Save heatmaps and pickles
# ------------------------------------------------------------------
heatmap_dir = base_path / 'heatmaps'
create_directory(heatmap_dir)

# Save plots with scale limits
save_heatmap(accuracy_map,   'Accuracy Heatmap',             'RdYlGn', 'heatmap_accuracy.png',   percent=True)
save_heatmap(clarity_map,    'Activity Difference Heatmap',              'plasma',   'heatmap_activity_difference.png',     vmin=0, vmax=140000)
save_heatmap(eff_inhib_map,  'Effective Inhibition Heatmap', 'seismic',  'heatmap_eff_inhib.png',   vmin=-3000, vmax=3000)
...
save_heatmap(sensitivity_map,'Decision-Making Competition Heatmap',          'RdYlGn','heatmap_decision_making_competition.png',percent=True)
save_heatmap(over_sens_map,  'Pre-Stimuli Decision Heatmap',     'RdYlGn_r','heatmap_pre_stimuli_decision.png',  percent=True)
...
print("✅ Heatmaps & Daten gespeichert unter:", heatmap_dir)'''
